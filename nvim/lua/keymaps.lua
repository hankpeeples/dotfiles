...
-- Use to trigger completion || `<S-space>` only works correctly in .lua files, don't know why.
map("i", "<S-space>", 'coc#pum#visible() ? coc#pum#next(1) : v:lua.check_back_space() ? "<S-space>" : coc#refresh()', { silent = true, expr = true })
